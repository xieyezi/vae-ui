...
import type { IMessage, MessageQueue, IMessageOptions, MessageVM, IMessageHandle } from './types'

import MessageConstructor from './index.vue'
import { isVNode } from 'vae-ui/utils/uitl'
...
const Message: IMessage = function (opts = {}): IMessageHandle {
	...
	vm = createVNode(MessageConstructor, options, isVNode(options.message) ? { default: () => message } : null)
